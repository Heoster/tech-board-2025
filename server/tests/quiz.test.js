...
describe('Quiz Routes', () => {
    ...
    beforeAll(async () => {
        ...
        const studentResult = await database.run(
            ...
            ['Test Student', 1, 6, 'A', '$2b$10$8K1p/a0dclxKxAYIGkqOKOb9/pGid/V2kzpR/hIxuEeRNqA6i7K3u']
        );
    ...
    describe('POST /api/quiz/start', () => {
        test('should start a quiz for authenticated student', async () => {
            ...
            expect(response.body.questions).toHaveLength(1); // Only 1 question in test DB
        });
